...
router.post('/enroll/:userType/:userId', auth, async (req: Request, res: Response) => {
  try {
...
router.get('/auth-data/:userType/:userId', auth, async (req: Request, res: Response) => {
  try {
    const { userType, userId } = req.params;
...
router.post('/verify/:userType/:userId', auth, async (req: Request, res: Response) => {
  try {
    const { userType, userId } = req.params;
