...
export default function ParentPortal() {
  ...
  const { data: attendance = [], isLoading: attendanceLoading } = useQuery<ChildAttendance[]>({
  ...
  // Fetch recent media
  const { data: mediaShares = [], isLoading: mediaLoading } = useQuery<MediaShare[]>({
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {mediaLoading ? (
                    ...
                    mediaShares.map((media: MediaShare) => (
