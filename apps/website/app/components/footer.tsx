        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-bold text-white">TotHub</span>
            </Link>
            <p className="text-sm leading-6 text-gray-300">
              Comprehensive daycare management platform with biometric authentication, compliance tracking, and real-time monitoring.
            </p>
