...
function getTestScenarios(deviceType: string, connectionType: string): Array<{ success: boolean; message: string; details?: any }> {
...
async function testExistingDevice(deviceId: string): Promise<{ success: boolean; message: string; details?: any }> {
